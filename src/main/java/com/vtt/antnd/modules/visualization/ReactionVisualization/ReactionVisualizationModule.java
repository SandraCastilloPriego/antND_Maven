 ...
 * @author scsandra
 */
public class ReactionVisualizationModule implements NDProcessingModule {

        public static final String MODULE_NAME = "Visualize reaction";
        private final ReactionVisualizationParameters parameters = new ReactionVisualizationParameters();
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new ReactionVisualizationTask[1];
                if (NDCore.getDesktop().getSelectedDataFiles().length == 0) {
                        NDCore.getDesktop().displayErrorMessage("You need to select a metabolic model.");
                } else {

                        tasks[0] = new ReactionVisualizationTask((SimpleBasicDataset) NDCore.getDesktop().getSelectedDataFiles()[0], (SimpleParameterSet) parameters);
