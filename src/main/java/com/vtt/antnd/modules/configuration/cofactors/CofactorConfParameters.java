...
public class CofactorConfParameters extends SimpleParameterSet {
        ...
        public static final StringParameter cofactors = new StringParameter("Cofactor ids", "The id all the cofactors in the model separated by comma", "C00003");
        public CofactorConfParameters() {
                super(new Parameter[]{cofactors});
        }
}
